...
Features I might implement myself:
 ...
 - More database backends (e.g. PostgreSQL).
...
Features we need to think about:
 ...
 - How should the higher-level object model look like? The
 grammar-based one is flexible, but creating SQL in it is rather
 verbose - an alternative would be nice.
